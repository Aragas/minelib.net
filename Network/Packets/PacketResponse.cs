...
namespace MinecraftClient.Network.Packets
{
    public static class ServerResponse
    {
        ...
        public static readonly CreatePacketInstance[] ServerPlayResponse =
        {
            ...
            null,//() => new BSpawnPlayerPacket(), // 0x0C // Метаданные не работают
            () => new CollectItemPacket(), // 0x0D
            () => new SpawnObjectPacket(), // 0x0E
            null,//() => new BSpawnMobPacket(), // 0x0F // Метаданные не работают
            ...
            () => new MapsPacket(), // 0x34
            null,//() => new MultiBlockChangePacket(), // 0x35 // Что-то не так
